...
const columns: GridColDef[] = [
  ...
  {
    field: "quantity_of_water_intake",
    headerName: "Quantity of Water Intake",
    width: 150,
  },
  {
    field: "quantity_of_measuring_unit",
    headerName: "Quantity of Measuring Unit",
    width: 150,
  },
  {
    field: "total_water_in_take",
    headerName: "Total Water In Take",
    width: 150,
  },
            ...
            {rows.map((row, index) => (
              ...
              >
                ...
                <TableCell align="right">
                  {row.quantity_of_measuring_unit}
                </TableCell>
                <TableCell align="right">
                  {row.quantity_of_water_intake}
                </TableCell>
